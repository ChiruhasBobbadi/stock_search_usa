...
(params: Params) => {
  ...
  // change this
  this.http.get ('http://ec2-18-234-143-36.compute-1.amazonaws.com/stockdetails?keyword='+this.ticker).subscribe ((dataobj) => {
...
this.innerSubscription =   this.http.get ('http://ec2-18-234-143-36.compute-1.amazonaws.com/summary?keyword='+this.ticker).subscribe ((dataobj) => {
  ...
  this.isLoading = false;
    ...
    this.chartSubscription = this.http.get('http://ec2-18-234-143-36.compute-1.amazonaws.com/daily?keyword='+this.ticker+'&startDate='+this.marketClosed).subscribe((data) =>{
    ...
    this.handleUpdate();
      ...
      this.http.get ('http://ec2-18-234-143-36.compute-1.amazonaws.com/history?keyword='+this.ticker+'&startDate='+this.marketClosed).subscribe ((data) => {
...
getNewsData()
{
        const url = "http://ec2-18-234-143-36.compute-1.amazonaws.com/news?keyword="+ this.ticker;
